---
title: "Model Selection for DCCC Data with Explanations"
output: 
  html_document: 
    highlight: textmate
    theme: cosmo
...
fail_prob = pbeta(ecdf(time_rep)(6200),fit_beta_mle$estimate[1],fit_beta_mle$estimate[2])

random_sample = rbeta(1000,fit_beta_mle$estimate[1],
                              fit_beta_mle$estimate[2])*10000
fail_prob2 = pbeta(ecdf(random_sample)(6200),
                   fit_beta_mle$estimate[1],fit_beta_mle$estimate[2])
