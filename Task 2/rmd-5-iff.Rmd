---
title: "Model Selection for iff Data with Explanations"
output: 
  html_document: 
    highlight: textmate
    theme: cosmo
...
```{r}
df_iff = read.csv('E:/2022/Freelance/Jobs/001-25/data-iff.csv', header=T)
df_iff = data.frame(time=df_iff$Time..hours., fails=df_iff$Number.of.failures)
```
...
```{r}
time_rep = rep(df_iff$time, df_iff$fails)
```
